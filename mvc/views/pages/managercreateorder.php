<div class="row">
    <div class="col-md-3 p-0 d-flex">
        <a href="http://<?php echo $GLOBALS['HOST']; ?>/baitap3/client/default/createorder" class="button container p-3 d-flex justify-content-center ">
            <div class="row">
    ...
    <div class="col-md-3 p-0 d-flex">
        <a href="http://<?php echo $GLOBALS['HOST']; ?>/baitap3/client" class="button container p-3 d-flex justify-content-center ">
    ...
    <div class="col-md-3 p-0 d-flex">
        <a href="http://<?php echo $GLOBALS['HOST']; ?>/baitap3/client/default/unsent" class="button container p-3 d-flex justify-content-center ">
    ...
    <div class="col-md-3 p-0 d-flex">
        <a href="http://<?php echo $GLOBALS['HOST']; ?>/baitap3/client/default/yetpay" class="button container p-3 d-flex justify-content-center ">
...
<div class="container-fuilt pt-5">
    ...
    <p style="font-size: 24px;color:white">Nội dung đơn</p>
        ...
        <form  id="createorder" action="http://<?php echo $GLOBALS['HOST']; ?>/baitap3/client/performcreateorder" method="POST">

                    ...
                    if ($data->num_rows > 0) {
                        while ($row = $data->fetch_assoc()) {
                            ...
                            for ($idx = 0; $idx < count($status); $idx++) {
                                ...
                                echo "<a href='http://{$GLOBALS['HOST']}/baitap3/admin/{$type}/{$row['id_order']}' id='status{$row['id_order']}' class='m-2 btn btn-success'>{$status[$idx]}</a>";
                            }
                            echo "<a href='http://{$GLOBALS['HOST']}/baitap3/admin/edit/{$row['id_order']}' class='m-2 btn btn-success'>Sửa đơn</a>";

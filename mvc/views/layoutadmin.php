...
<header style="background-color:#3b3b3b;" class="sticky-top">
    <div class="row d-flex">
        ...
        <form method="POST" class="col d-flex justify-content-end pr-3 pt-2 pb-2" action="http://<?php echo $GLOBALS['HOST']; ?>/baitap3/admin/search">
...
<body style="color:white;">
    <div id="menuleft" class="menu">
        ...
        <nav class="mt-3">
            <ul class="p-2">
                <li><a href="http://<?php echo $GLOBALS['HOST'];?>/baitap3/admin/statistical" class="btn-menu p-3">Thống kê</a><span style="color: red;font-size: 10px">đang hoàn thiện</span></li>
                <li><a href="" class="btn-menu p-3">Mặt hàng</a><span style="color: red;font-size: 10px"> đang hoàn thiện</span></li>
                <li><a href="http://<?php echo $GLOBALS['HOST']; ?>/baitap3/logout" class="btn-menu p-3">Đăng xuất</a></li>
            </ul>
        </nav>
    </div>

    ...
    function __construct()
    {
        ...
        if (isset($_SESSION['user'])) {
            ...
            if (!$this->md->isClient($this->user)) {
                header("Location:http://{$GLOBALS['HOST']}/baitap3/admin");
            }
        }
        if (!isset($_SESSION['user'])) {
        ...
        if (!empty($_POST['contentorder']) && !empty($_POST['linkfb']) && !empty($_POST['price'])) {
            ...
            echo "
                    <script>
                        ...
                        setTimeout(function(){
                            window.location = 'http://{$GLOBALS['HOST']}/baitap3/client';
                        }, 500);
            ...
            echo "
                    <script>
                        ...
                        setTimeout(function(){
                            window.location = 'http://{$GLOBALS['HOST']}/baitap3/client/default/createorder';
                        }, 1000);
                    </script>
                ";
        }
